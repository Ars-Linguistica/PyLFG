...
# -*- coding: utf-8 -*-
#
# PyLFG documentation build configuration file, created by
...
version = pylfg.__version__
# The full version, including alpha/beta/rc tags.
release = pylfg.__version__
...
html_use_opensearch = 'https://pylfg.readthedocs.io/en/latest/'

# This is the file name suffix for HTML files (e.g. ".xhtml").
#html_file_suffix = None

# Output file base name for HTML help builder.
htmlhelp_basename = 'pylfgdoc'
